...
public class RespNaturezaDAO 
{
    ...
    throws Exception
  {
     ...
     catch(Exception e)
     {
        ...
        throw new Exception("Ocorreram erros ao se tentar buscar o nome e o e-mail do"+
             " respons?vel pela natureza "+natureza);
     }
     return responsaveis;
  }
     ...
     throws Exception
  {
     ...
     {
       e.printStackTrace();
       throw new Exception("Ocorreram erros ao se inserir um novo respons?vel "+
     ...
     throws Exception
  {
     ...
     {
       e.printStackTrace();
       throw new Exception("Ocorreram erros ao se tentar remover o respons?vel "+
                "pela natureza "+natureza);
     }
  }
    ...
    throws Exception
  {
    ...
    {
      e.printStackTrace();
      throw new Exception("Erro ao fechar a conexao");
    }
  }
}